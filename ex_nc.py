...
'''
    This is the code for the NetCDF extractor.  This takes a file deemed a NetCDF file 
    and extracts all metadata from it as a JSON.

    @Inputs: path -- relative or absolute path to file.
    @Outputs: metadata -- metadata JSON

    @Author: Tyler J. Skluzacek
    @LastEdited: 05/02/2019
'''
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', help='Path (relative or absolute) to NetCDF file')
